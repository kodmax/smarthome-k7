...
export const Commodities: FC<Record<string, never>> = () => {
  const zoom = useZoom('commodities')
        ...
        <ApolloDataTable>
          <TableBody>
            <ApolloTableRow>
              ...
              <ApolloTableCell sx={{ display: zoom ? 'initial' : 'none' }}>12 mscy</ApolloTableCell>
            ...
            <ApolloTableRow>
              ...
              <ApolloTableCell sx={{ display: zoom ? 'initial' : 'none' }}>30 dni</ApolloTableCell>
              <ApolloTableCell sx={{ width: '4em', padding: 0 }}>
                <Graph
                  scaleX={30}
            ...
            {!jobs ? null : (
              <ApolloTableRow>
                ...
                <ApolloTableCell sx={{ display: zoom ? 'initial' : 'none' }}>365 dni</ApolloTableCell>
                <ApolloTableCell sx={{ width: '4em', padding: 0 }}>
