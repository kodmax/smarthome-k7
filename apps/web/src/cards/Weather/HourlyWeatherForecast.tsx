          ...
          <tbody>
            <tr>
              {forecast?.hourly.map((fc: HourWeatherForecast) => (
                <td key={fc.hour} style={{ minWidth: '3em', maxWidth: '3em', fontSize: '0.7em' }}>
                  {fc.hour}
                </td>
              ))}
            </tr>
            ...
            <tr>
              {forecast?.hourly.map((fc: HourWeatherForecast) => (
                <td key={fc.hour} style={{ fontSize: '0.7em' }}>
                  {Number(fc.temp).toFixed(0)} °C
                </td>
              ))}
            </tr>
            <tr>
            ...
            <tr>
              {forecast?.hourly.map((fc: HourWeatherForecast) => (
                <td key={fc.hour} style={{ fontSize: '0.5em' }}>
                  {Number(fc.sun.altitude).toFixed(0)}°
                </td>
              ))}
            </tr>
          </tbody>
