          ...
          <tbody>
            <tr>
              ...
              <td style={{ width: '4em', padding: 0 }}>
                <Graph data={reading['NBP Ref.'].history} scaleX={30} scaleY={1} valueKey='rate' />
              </td>
            ...
            <tr>
              <td>Wibor 1M</td>
              <td style={{ width: '4em', padding: 0 }}>
                <Graph data={reading['WIBOR 1M'].history} scaleX={30} scaleY={1} valueKey='rate' />
              </td>
            ...
            <tr>
              <td>Wibor 3M</td>
              <td style={{ width: '4em', padding: 0 }}>
                <Graph data={reading['WIBOR 3M'].history} scaleX={30} scaleY={1} valueKey='rate' />
              </td>
            ...
            <tr>
              <td>Wibor 6M</td>
              <td style={{ width: '4em', padding: 0 }}>
                <Graph data={reading['WIBOR 6M'].history} scaleX={30} scaleY={1} valueKey='rate' />
              </td>
