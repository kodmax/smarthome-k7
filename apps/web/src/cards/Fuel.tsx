            ...
            { !reading ? (<TablePlaceholder rows={4} graph={true} value={true} />) : (
                <table className='apollo-data-table'>
                    <tbody>
                        <tr>
                            <td>Pb 98</td>
                            <td style={{ width: '4em', padding: 0 }}><Graph data={reading['98'].history} scaleX={30} scaleY={2} valueKey={'price'} /></td>
                            <td>{Number(reading['98'].current).toFixed(2)} zł/ℓ</td>
                        </tr>
                        <tr>
                            <td>Pb 95</td>
                            <td style={{ width: '4em', padding: 0 }}><Graph data={reading['95'].history} scaleX={30} scaleY={2} valueKey={'price'} /></td>
                            <td>{Number(reading['95'].current).toFixed(2)} zł/ℓ</td>
                        </tr>
                        <tr>
                            <td>LPG</td>
                            <td style={{ width: '4em', padding: 0 }}><Graph data={reading.LPG.history} scaleX={30} scaleY={1} valueKey={'price'} /></td>
                            <td>{Number(reading.LPG.current).toFixed(2)} zł/ℓ</td>
                        </tr>
                        <tr>
                            <td>ON</td>
                            <td style={{ width: '4em', padding: 0 }}><Graph data={reading.ON.history} scaleX={30} scaleY={2} valueKey={'price'} /></td>
