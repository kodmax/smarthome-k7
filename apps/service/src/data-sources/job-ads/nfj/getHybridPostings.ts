    ...
    () =>
      fetch(hybridPostingsUrl, {
        headers: {
          ...
          cookie: config.jobAds.nfjCookie,
          Referer:
            'https://nofluffjobs.com/pl/praca-zdalna/frontend?criteria=city%3Dwarszawa%20%20keyword%3Djava-script',
        },
