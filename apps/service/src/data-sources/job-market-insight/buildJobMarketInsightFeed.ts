...
export const buildJobMarketInsightFeed = (ads: JobAd[]): JobMarketInsightMetrics => ({
  ...
  remoteWorkPercent: computePercent(ads, ad => ad.workplaceType === 'remote'),
  hybridWorkPercent: computePercent(ads, ad => ad.workplaceType === 'hybrid'),
  officeWorkPercent: computePercent(ads, ad => ad.workplaceType === 'office'),
