...
import { SetSkillCommentDto, SetSkillLevelDto } from './my-skills.commands.dto'

@Controller('data-sources/my-skills/command')
export class MySkillsCommandsController {
