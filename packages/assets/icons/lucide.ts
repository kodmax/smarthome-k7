...
export const JobAdsIcon = createStyledIcon(BriefcaseBusiness, iconStyles.neutral)
export const JobMarketActiveOffersIcon = createStyledIcon(BriefcaseBusiness, iconStyles.jobAds)
export const JobMarketNewOffersIcon = createStyledIcon(TrendingUp, iconStyles.energy)
export const JobMarketSalaryRangeIcon = createStyledIcon(SlidersHorizontal, iconStyles.jobAds)
