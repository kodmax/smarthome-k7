...
This repository is a monorepo. Its root folder holds shared configuration that applies across packages, including the
root `.gitignore`, shared ESLint presets in `packages/eslint-config/`, and shared TypeScript bases in
